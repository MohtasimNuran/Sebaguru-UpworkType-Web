<%@ Page Title="" Language="C#" MasterPageFile="~/JobSeekerMasterPage.Master" AutoEventWireup="true" CodeBehind="UpdateCategoryForJobSeeker.aspx.cs" Inherits="UpWorkWeb.UpdateCategoryForJobSeeker" %>
        ...
        <div class="row">
            ...
            <div style="background-color: white" class="panel panel-default">
                ...
                <div style="background-color: #007dc6; -webkit-border-radius: 10px" class="panel-heading">
                    ...
                    <h2 align="center" style="color: white"><strong>All Categories</strong></h2>
                ...
                <div class="row panel-body">
                    ...
                    <div class="col-md-2">
                        ...
                        <br />
                        <asp:Button ID="UpdateButton" runat="server" Text="Update" CssClass="btn btn-lg btn-primary" Font-Size="Large" OnClick="UpdateButton_OnClick"/>
                    </div>
