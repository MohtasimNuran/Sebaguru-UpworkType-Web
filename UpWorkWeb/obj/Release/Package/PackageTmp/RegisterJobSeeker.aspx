<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/PartialMasterPage.Master" CodeBehind="RegisterJobSeeker.aspx.cs" Inherits="UpWorkWeb.RegisterJobSeeker" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBody" runat="server">
    ...
    <div class="container panel">
        ...
        <div class="col-md-12">
            ...
            <h1 style="color: #1e90ff;">Registration form for Job Seeker</h1>
        ...
        <div class="col-md-6">
            ...
            <div class="form-group col-lg-12">
                <label>Experience and useful link</label>
                <asp:TextBox ID="commentBoxTextBox" runat="server" TextMode="MultiLine" CssClass="form-control" Height="100px"></asp:TextBox>
            </div>
            <div class="col-sm-12">
                <br />
        ...
        <br />
        <div class="col-md-6">
            <h3 class="dark-grey" style="color: #1e90ff">Professional Information</h3>
            <hr style="height: 1px; background-color: #1e90ff;" />
            <div class="form-group col-lg-6">
                <label>Available Time Starts</label>
            ...
            <div class="form-group col-lg-6">
                <label>Available Time Ends</label>
