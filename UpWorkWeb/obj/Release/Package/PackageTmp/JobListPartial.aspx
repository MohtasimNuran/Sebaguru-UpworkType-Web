<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/PartialMasterPage.Master" CodeBehind="JobListPartial.aspx.cs" Inherits="UpWorkWeb.JobListPartial" %>
                ...
                <div class="row">
                    ...
                    <div class="col-md-10" style="position: inherit">
                        <asp:Repeater ID="Repeater2" runat="server" OnItemCommand="Repeater2_OnItemCommand">
                            <ItemTemplate>
                                <div class="">
                                    <table class="table table-hover table-responsive table-striped" style="border: 5px; background-color: #dcdcdc; -webkit-border-radius: 5px !important;">
                                        <tr>
                                            <td>
                                                <h4>
