<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/JobSeekerMasterPage.Master" CodeBehind="WorkingJobListForJobSeeker.aspx.cs" Inherits="UpWorkWeb.WorkingJobListForJobSeeker" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBody" runat="server">
    <div class="container-fluid" style="background-color: #dcdcdc; min-height: 100vh" >
        ...
        <div class="container panel">
            ...
            <h1 style="color: #1e90ff">Working Job List</h1>
            <br />
            <hr />
