<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoogleLogin.aspx.cs" Inherits="UpWorkWeb.GoogleLogin" %>
...
<body>
    ...
    <%--<div>
        ...
        <br />
        <asp:Label ID="Label6" runat="server" Text="Google Id"></asp:Label>
        <asp:Label ID="googleIdLabel" runat="server"></asp:Label>
        <br />
        <hr/>
        ...
        <input type="date" id="birthDateTextBox" runat="server"/>
        <br />
        ...
        <br />
        <asp:Label ID="Label12" runat="server" Text="Comment About Yourself"></asp:Label>
        <asp:TextBox ID="commentTextBox" runat="server"></asp:TextBox>
        <br />
        <asp:Label ID="Label13" runat="server" Text="Password(if u deactivate ur Fb)"></asp:Label>
        ...
        <div class="container" style="background-color: #dcdcdc">
            <div class="col-md-12">
                ...
                <br />
                <br />
                <h1 style="color: #1e90ff;">Registration form for Job Seeker by Google</h1>
                <br />
                <br />
                <hr />
            </div>
            <div class="col-md-6">
                ...
                <div class="form-group col-lg-6">
                    ...
                    <asp:Label ID="googleIdLabel" runat="server" CssClass="form-control"></asp:Label>
                </div>
                ...
                <div class="form-group col-lg-6">
                    <label>Password(if u deactivate ur google)</label>
